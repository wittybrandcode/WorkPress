...
| **7** | [`assets/src/components/WebhooksSettingsTab.js`](file:///c:/laragon/www/WORKPRESS/wp-content/plugins/WorkPress/assets/src/components/WebhooksSettingsTab.js) | **6.4 KB** | **189** | عزل لافتة الهيرو، قائمة النقاط، فاحص السجلات، ونافذة الإضافة. | `assets/src/components/webhooks/`<br>✅ `WebhooksHeroBanner.js`<br>✅ `WebhookEndpointsList.js`<br>✅ `WebhookDeliveryLogs.js`<br>✅ `WebhookModal.js` | ✅ **مُنجز ومثبت** |
...
|---|---|:---:|:---:|---|---|:---:|
| **1** | [`includes/api/class-workpress-rest-portal-controller.php`](file:///c:/laragon/www/WORKPRESS/wp-content/plugins/WorkPress/includes/api/class-workpress-rest-portal-controller.php) | **10.5 KB** | **345** | متحكم وموجه رشيق يوجه الـ 22 نقطة نهاية للبوابة. | `includes/api/portal/`<br>✅ `class-workpress-portal-auth-handler.php`<br>✅ `class-workpress-portal-requests-handler.php`<br>✅ `class-workpress-portal-projects-handler.php`<br>✅ `class-workpress-portal-pulse-handler.php` | ✅ **مُنجز ومثبت** |
| **2** | [`includes/services/class-workpress-portal-service.php`](file:///c:/laragon/www/WORKPRESS/wp-content/plugins/WorkPress/includes/services/class-workpress-portal-service.php) | **30.2 KB** | **685** | خدمة توجيه البوابة، عزل الصلاحيات، وإشعارات النبض اللحظي. | فصل خدمة الاعتماد والتوقيع الرقمي في:<br>✅ [`class-workpress-portal-signoff-service.php`](file:///c:/laragon/www/WORKPRESS/wp-content/plugins/WorkPress/includes/services/class-workpress-portal-signoff-service.php) | ✅ **مُنجز ومثبت** |
| **3** | [`includes/services/class-workpress-task-service.php`](file:///c:/laragon/www/WORKPRESS/wp-content/plugins/WorkPress/includes/services/class-workpress-task-service.php) | **27.6 KB** | **850** | إدارة عمليات الـ CRUD، التروية الجماعية (Hydration)، وقوائم الفحص وتتبع الوقت. | فصل آلة الحالات (State Machine) ودورة الحياة في:<br>✅ [`class-workpress-task-state-machine.php`](file:///c:/laragon/www/WORKPRESS/wp-content/plugins/WorkPress/includes/services/class-workpress-task-state-machine.php) | ✅ **مُنجز ومثبت** |
| **4** | [`includes/services/class-workpress-contribution-service.php`](file:///c:/laragon/www/WORKPRESS/wp-content/plugins/WorkPress/includes/services/class-workpress-contribution-service.php) | **29.8 KB** | **880** | تسجيل مسار المساهمات والأدلة، خيوط النقاش والتعليقات، وسجلات النظام. | فصل اعتماد الحلول والتحول المعرفي في:<br>✅ [`class-workpress-solution-transform-service.php`](file:///c:/laragon/www/WORKPRESS/wp-content/plugins/WorkPress/includes/services/class-workpress-solution-transform-service.php) | ✅ **مُنجز ومثبت** |
