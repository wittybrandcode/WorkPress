 ...
 *
 * Renders the exact official vector paths of workpress.svg
 * with emerald green (#10b981) for "Work" and deep slate (#00192f) for "Press".
 *
 * @param {Object} props
 * @param {number} [props.height=28] - Rendered height in pixels
 * @param {boolean} [props.dark=false] - Light mode fill for dark backgrounds
