/**
 * WorkPress Client Portal: Core Services & Utilities
 * 
 * Provides API client, Audio Engine, and Brand SVG Assets.
 * 
 * @package WorkPress
 * @subpackage Portal
 * @version 2.2.1
...
(function(exports) {
     ...
     */
    exports.apiFetch = async function(endpoint, method = 'GET', body = null, isRetry = false) {
            ...
            if ((res.status === 403 || json.code === 'rest_cookie_invalid_nonce') && !isRetry && endpoint !== 'refresh-nonce') {
                try {
                    ...
                    if (refreshJson && refreshJson.nonce) {
                        ...
                        return await exports.apiFetch(endpoint, method, body, true);
                    }
                } catch (retryErr) {
    ...
    exports.playPortalSound = async function(soundName) {
        try {
     ...
     */
    exports.playClockTick = function() {
        try {
